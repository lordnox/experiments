...
angular.module('11App').controller('MainCtrl', function ($scope) {
  ...
  var _justify = (function() {
    ...
    var _calc = function(recurse, i, args) {
      var words = args[0], config = args[1];
  ...
  var _fib = recurseFactory(function _init(n) {
    return [n,n];
  }, function _break(_, n) {
    return n == 0;
  ...
  just("Lorem ipsum dolor sit amet, consetetur sadipscing", {max: 40});
